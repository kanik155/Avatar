...
namespace Dissonance.Audio.Playback
{
        ...
        : IJitterEstimator
    {
        ...
        {
            // Set the "active" session to null (the one at the _back_ of the queue with new packets being added to it)
            _active = null;

            // Dequeue all pending sessions and discard
            ...
            while (_awaitingActivation.Count > 0)
                _awaitingActivation.Dequeue();
